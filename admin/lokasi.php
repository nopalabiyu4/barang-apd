                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from tbl_lokasi order by lokasi_nama ASC");
											$no=1;
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <h4 class="modal-title">Hapus Area Lokasi <?php echo $p['lokasi_nama']?></h4>
