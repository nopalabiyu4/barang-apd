...
<head>
    ...
    <title>Safety | Kelola Data Karyawan</title>
                            ...
                            <div class="card-body">
                                ...
                                <ol class="breadcrumb mb-4">
                                    <ul class="breadcrumbs pull-left">
                                        ...
                                        <li><span>Kelola Data Karyawan</span></li>
                                    </ul>
                                </ol>
                                <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from karyawan order by nama_karyawan, bundy");
											$no=1;
                                            ...
                                            if(isset($_POST['karyawanbaru'])){
                                                $bundy=$_POST['bundy'];
                                                $nama_karyawan=$_POST['nama_karyawan'];
                                                    
                                                $query = mysqli_query($conn,"insert into karyawan values('','$bundy','$nama_karyawan')");
                                                if ($query){

                                                echo " <div class='alert alert-success'>
                                                    <strong>Success!</strong> Redirecting you back in 1 seconds.
                                                </div>
                                                <meta http-equiv='refresh' content='1; url= ../admin/karyawan.php'/>  ";
                                            ...
                                            if(isset($_POST['update'])){
                                                ...
                                                $updatedata = mysqli_query($conn,"update karyawan set bundy='$bundy', nama_karyawan='$nama_karyawan' where idx='$idx'");
                                            ...
                                            if(isset($_POST['hapus'])){
                                                ...
                                                $delete = mysqli_query($conn,"delete from karyawan where idx='$idx'");
                                                if ($delete){
									...
									<a href="exportdatakyw.php" target="_blank" class="btn btn-info">Export Data Karyawan</a>
                                </div>
                            </div>
                        </div>
                    </div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="modal-footer">
								...
								<input type="submit" class="btn btn-primary" value="Simpan" name="karyawanbaru">
							</div>
						</form>
					</div>
				</div>
